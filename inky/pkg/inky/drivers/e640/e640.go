...
// Accepts a configured common.InkyConfig with all required interfaces
func New(config common.InkyConfig) (*E640Display, error) {
	display := &E640Display{
		config:      config,
...
func (d *E640Display) init() error {
	...
	d.sendCommand(phat.CmdTRES, []byte{0x01, 0x90, 0x02, 0x58})
...
func (d *E640Display) Update() error {
	...
	d.sendCommand(phat.CmdBTST2, []byte{0x6F, 0x1F, 0x17, 0x47})
...
func (d *E640Display) Fill(color common.Color) {
...
func (d *E640Display) SupportedColors() []common.Color {
...
func (d *E640Display) SupportsColor(color common.Color) bool {
